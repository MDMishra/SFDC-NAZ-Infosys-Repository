        ...
        for(ONTAP__Order__c OnTap:trigger.new)
        {
            ...
            if(OnTap.RAS_WSLRNbrCustIDRouteNbr__c !=null)
            {
               ...
               if(userinfo.getuserroleid() != null){
                    list<userrole> ur2 = [select id, userrole.name from userrole where ParentRoleID =: userinfo.getuserroleid() limit 1];
                    ...
                    if(ur2 != null && !ur2.isEmpty())
                        u = [select id,userroleid from user where userroleid =: ur2[0].id limit 1];                    
